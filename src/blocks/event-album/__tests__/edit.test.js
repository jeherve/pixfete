...
describe('Edit — password validation', () => {
	...
	test('locks post saving and shows error when password is too short', () => {
		render(
			<Edit
				attributes={{
					password: 'short',
	...
	test('unlocks post saving when password meets minimum length', () => {
		render(
			<Edit
				attributes={{
	...
	test('does not show error or lock saving when password is empty', () => {
	...
	test('locks saving for password of exactly 7 characters', () => {
		render(
			<Edit
				attributes={{
					password: 'evelyne',
	...
	test('unlocks saving for password of exactly 8 characters', () => {
		render(
			<Edit
				attributes={{
					password: 'exactly8',
